...
const infoNoticias = [
    ...
    ["Funcionarios y Estudiantes en actividad por la Semana Santa (2022)", "Actividad espiritual y socioemocional en torno a la reflexion de semana santa con funcionarias, funcionarios y estudiantes del Colegio Luterano.", "/news/Abr142022/semanaSantaFuncionarios.html", `src="/sources/Images/Colegio/Reuniones-y-cultos/Actividad Semana Santa Profesores 1.webp" alt="Funcionarios en actividad de Semana Santa"`],

    ["Visita del Conejo de Pacua al Colegio Luterano. (2022)", "Visita del conejito de pascua a los estudiantes de prekinder a segundo básico.", "/news/Abr142022/conejoDePascua.html", `src="/sources/Images/Colegio/Celebraciones/Conejo de Pascua Colegio Luterano 2022 1.webp" alt="Conejo de pascua en el Colegio Luterano"`],

    ["Nuevo centro de Estudiantes del Colegio Luterano.", "Les presentamos al nuevo centro de estudiantes elegido en nuetro colegio.", "/news/Abr52022/centroDeEstudiantes.html", `src="/sources/Images/Colegio/Grupos/Consejo de Estudiantes 2022 1.webp" style="object-position: center 31%;" alt="Centro de Estudiantes Colegio Luterano (2022)"`],

    ["Culto de instalación de nuevas funcionarias en el Colegio Luterano", "El domingo 6 de Marzo del 2022 la <b>Iglesia Evangélica Luterana en Magallanes (IELMA)</b> ofició en el culto eucarístico la instalación de las nuevas funcionarias del  <b>Colegio Luterano</b>.", "/news/Mar62022/Mar62022.html", `src="/sources/Images/Colegio/Reuniones-y-cultos/nuevasFuncionarias.webp" alt="Nuevas Funcionarias Colegio Luterano"`]
